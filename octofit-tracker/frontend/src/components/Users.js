...
function Users() {
  ...
  const filteredItems = items.filter((item) => {
    const value = `${item.name || ''} ${item.email || ''} ${item.team || ''}`.toLowerCase();
    ...
    <div className="card shadow-sm border-0">
      <div className="card-body">
        <div className="d-flex justify-content-between align-items-center mb-3">
          ...
          <a className="link-primary" href="#users-table">
            Jump to table
          </a>
        </div>
        ...
        <div className="table-responsive" id="users-table">
            ...
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <p className="mb-1"><strong>Name:</strong> {selectedItem.name}</p>
                  <p className="mb-1"><strong>Email:</strong> {selectedItem.email}</p>
                  <p className="mb-0"><strong>Team:</strong> {selectedItem.team}</p>
                </div>
