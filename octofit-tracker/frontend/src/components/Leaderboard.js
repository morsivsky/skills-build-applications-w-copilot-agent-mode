...
function Leaderboard() {
  ...
  useEffect(() => {
    ...
    fetch(baseUrl)
      ...
      .catch((fetchError) => {
        setError(fetchError.message || 'Failed to fetch leaderboard');
      })
      .finally(() => {
        setLoading(false);
      });
  ...
  const filteredItems = items.filter((item) => {
    const value = `${item.team || ''} ${item.points || ''}`.toLowerCase();
    ...
    <div className="card shadow-sm border-0">
      <div className="card-body">
        <div className="d-flex justify-content-between align-items-center mb-3">
          ...
          <a className="link-primary" href="#leaderboard-table">
            Jump to table
          </a>
        </div>
        ...
        <div className="table-responsive" id="leaderboard-table">
            ...
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <p className="mb-1"><strong>Team:</strong> {selectedItem.team}</p>
                  <p className="mb-0"><strong>Points:</strong> {selectedItem.points}</p>
                </div>
